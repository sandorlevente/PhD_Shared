...
void squarePoiseuilleSetup(
    ...
    OnLatticeBoundaryCondition3D<T, DESCRIPTOR> &boundaryCondition, T frequency, T amplitude)
{
    ...
    initializeAtEquilibrium(
        lattice, lattice.getBoundingBox(), Array<T, 3>((T)0.0, (T)0.0, (T)0.0));

    Array<T, DESCRIPTOR<T>::d> force(womersleyForce((T)0, amplitude, frequency), 0.);
    setExternalVector(
